  ...
  <div class="page-container">
    ...
    <div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
      <el-form :inline="true" :model="filters" :size="size">
        ...
        <el-form-item>
          <fm-button icon="fa fa-search" :label="$t('action.search')" perms="sys:loginlog:view" type="primary" @click="findPage(null)"/>
        </el-form-item>
      </el-form>
    </div>
    <!--表格内容栏-->
...
<script>
  ...
  import { LOGIN_LOG_PAGE } from '@/api/modules/loginlog.js';
  export default {
    components: {
      FmTable,
      FmButton
    ...
    methods: {
      ...
      findPage: function (data) {
        ...
        LOGIN_LOG_PAGE(this.pageRequest).then((res) => {
          this.pageResult = res
