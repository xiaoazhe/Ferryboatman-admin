  ...
  <div>
    ...
    <el-table :data="dataForm.content"
      ...
      <el-table-column prop="createTime"
                       label="创建时间"
                       sortable="custom" />
      <el-table-column prop="isOriginal"
                       label="原创"
                       sortable="custom">
        <template slot-scope="scope">
      ...
      <el-table-column prop="author"
                       ...
                       width="200"
                       show-overflow-tooltip />
      <el-table-column prop="articlesPart"
                       label="出处"
                       width="200"
                       show-overflow-tooltip />
...
<script>
  import { BLOG_SAVE, BLOG_PAGE, BLOG_DELETE_BATCH, BLOG_DELETE_ID, BLOG_GET_BY_ID, BLOG_USER_PAGE, BLOG_USER_DELETE_ID } from '@/api/modules/blog.js';
  import { GET_FILE_CONFIG, FDFS_UPLOAD, FDFS_DELETE, FILE_CONFIG } from '@/api/modules/file.js';
  import { TYPE_DELETE, TYPE_SAVE, TYPE_BY_ID, TYPE_FIND_ALL, TYPE_PAGE } from '@/api/modules/type.js';
  export default {
    components: {
